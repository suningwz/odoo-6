...
class IrActionsReport(models.Model):
    ...
    specific_document_name = fields.Char(string='Specific Document Name')
    ...
    def gen_report_download_filename(self, res_ids, data):
        ...
        if report.specific_document_name:
            return "{0}.{1}".format(report.specific_document_name, self.py3o_filetype)
